...
static void __initConstants( void )
{
    ...
    const_str_digest_03937373fabec6b1a26cee54a73d4917 = UNSTREAM_STRING( &constant_bin[ 32242 ], 28, 0 );
    const_str_digest_1bcbfd703e41ba80195b5a84d610dbd4 = UNSTREAM_STRING( &constant_bin[ 32270 ], 20, 0 );
    const_str_digest_dc2a0cea0cc8765646e6551215b10eac = UNSTREAM_STRING( &constant_bin[ 32290 ], 20, 0 );
    ...
    const_str_plain_MAX_NODE_LIMIT = UNSTREAM_STRING( &constant_bin[ 32310 ], 14, 1 );
    ...
    const_str_plain___all__ = UNSTREAM_STRING( &constant_bin[ 32324 ], 7, 1 );
    const_str_plain___builtins__ = UNSTREAM_STRING( &constant_bin[ 32331 ], 12, 1 );
    const_str_plain___class__ = UNSTREAM_STRING( &constant_bin[ 32343 ], 9, 1 );
    const_str_plain___cmp__ = UNSTREAM_STRING( &constant_bin[ 32352 ], 7, 1 );
    const_str_plain___delattr__ = UNSTREAM_STRING( &constant_bin[ 32359 ], 11, 1 );
    const_str_plain___dict__ = UNSTREAM_STRING( &constant_bin[ 32370 ], 8, 1 );
    const_str_plain___doc__ = UNSTREAM_STRING( &constant_bin[ 32378 ], 7, 1 );
    const_str_plain___enter__ = UNSTREAM_STRING( &constant_bin[ 32385 ], 9, 1 );
    const_str_plain___exit__ = UNSTREAM_STRING( &constant_bin[ 32394 ], 8, 1 );
    const_str_plain___file__ = UNSTREAM_STRING( &constant_bin[ 32402 ], 8, 1 );
    const_str_plain___getattr__ = UNSTREAM_STRING( &constant_bin[ 32410 ], 11, 1 );
    const_str_plain___import__ = UNSTREAM_STRING( &constant_bin[ 32421 ], 10, 1 );
    const_str_plain___init__ = UNSTREAM_STRING( &constant_bin[ 9007 ], 8, 1 );
    const_str_plain___main__ = UNSTREAM_STRING( &constant_bin[ 32431 ], 8, 1 );
    const_str_plain___metaclass__ = UNSTREAM_STRING( &constant_bin[ 32439 ], 13, 1 );
    const_str_plain___module__ = UNSTREAM_STRING( &constant_bin[ 32452 ], 10, 1 );
    const_str_plain___name__ = UNSTREAM_STRING( &constant_bin[ 32462 ], 8, 1 );
    const_str_plain___setattr__ = UNSTREAM_STRING( &constant_bin[ 32470 ], 11, 1 );
    const_str_plain_add = UNSTREAM_STRING( &constant_bin[ 5945 ], 3, 1 );
    const_str_plain_adjacent = UNSTREAM_STRING( &constant_bin[ 4595 ], 8, 1 );
    const_str_plain_append = UNSTREAM_STRING( &constant_bin[ 32481 ], 6, 1 );
    ...
    const_str_plain_compile = UNSTREAM_STRING( &constant_bin[ 32487 ], 7, 1 );
    const_str_plain_contains_node = UNSTREAM_STRING( &constant_bin[ 32494 ], 13, 1 );
    const_str_plain_contains_one_move = UNSTREAM_STRING( &constant_bin[ 7402 ], 17, 1 );
    const_str_plain_contains_span = UNSTREAM_STRING( &constant_bin[ 32507 ], 13, 1 );
    ...
    const_str_plain_delta = UNSTREAM_STRING( &constant_bin[ 32520 ], 5, 1 );
    ...
    const_str_plain_exc_traceback = UNSTREAM_STRING( &constant_bin[ 32525 ], 13, 1 );
    const_str_plain_exc_type = UNSTREAM_STRING( &constant_bin[ 32538 ], 8, 1 );
    const_str_plain_exc_value = UNSTREAM_STRING( &constant_bin[ 32546 ], 9, 1 );
    const_str_plain_exit = UNSTREAM_STRING( &constant_bin[ 32396 ], 4, 1 );
    ...
    const_str_plain_get_base_region = UNSTREAM_STRING( &constant_bin[ 32555 ], 15, 1 );
    const_str_plain_get_chord_by_node = UNSTREAM_STRING( &constant_bin[ 32570 ], 17, 1 );
    const_str_plain_get_compressed_diagram = UNSTREAM_STRING( &constant_bin[ 6215 ], 22, 1 );
    const_str_plain_get_first_region_id = UNSTREAM_STRING( &constant_bin[ 32587 ], 19, 1 );
    const_str_plain_get_lower_node = UNSTREAM_STRING( &constant_bin[ 32606 ], 14, 1 );
    const_str_plain_get_next_region_id = UNSTREAM_STRING( &constant_bin[ 32620 ], 18, 1 );
    const_str_plain_get_node_complement = UNSTREAM_STRING( &constant_bin[ 32638 ], 19, 1 );
    ...
    const_str_plain_get_upper_node = UNSTREAM_STRING( &constant_bin[ 32657 ], 14, 1 );
    ...
    const_str_plain_inspect = UNSTREAM_STRING( &constant_bin[ 32671 ], 7, 1 );
    const_str_plain_int = UNSTREAM_STRING( &constant_bin[ 4640 ], 3, 1 );
    const_str_plain_is_node_on_region = UNSTREAM_STRING( &constant_bin[ 32678 ], 17, 1 );
    ...
    const_str_plain_math = UNSTREAM_STRING( &constant_bin[ 32695 ], 4, 1 );
    const_str_plain_max_node_closed = UNSTREAM_STRING( &constant_bin[ 32699 ], 15, 1 );
    const_str_plain_minus = UNSTREAM_STRING( &constant_bin[ 25844 ], 5, 1 );
    const_str_plain_msg = UNSTREAM_STRING( &constant_bin[ 31522 ], 3, 1 );
    ...
    const_str_plain_open = UNSTREAM_STRING( &constant_bin[ 32714 ], 4, 1 );
    ...
    const_str_plain_pop = UNSTREAM_STRING( &constant_bin[ 32718 ], 3, 1 );
    ...
    const_str_plain_region_factory = UNSTREAM_STRING( &constant_bin[ 32721 ], 14, 1 );
    ...
    const_str_plain_reverse = UNSTREAM_STRING( &constant_bin[ 32735 ], 7, 1 );
    ...
    const_str_plain_split = UNSTREAM_STRING( &constant_bin[ 32742 ], 5, 1 );
    const_str_plain_staticmethod = UNSTREAM_STRING( &constant_bin[ 32747 ], 12, 1 );
    const_str_plain_stderr = UNSTREAM_STRING( &constant_bin[ 31666 ], 6, 1 );
    ...
    const_str_plain_type = UNSTREAM_STRING( &constant_bin[ 31045 ], 4, 1 );
    const_str_plain_update_dangling_spans = UNSTREAM_STRING( &constant_bin[ 32759 ], 21, 1 );
    const_str_plain_xrange = UNSTREAM_STRING( &constant_bin[ 32780 ], 6, 1 );
