...
static void __initConstants( void )
{
    ...
    const_str_digest_03937373fabec6b1a26cee54a73d4917 = UNSTREAM_STRING( &constant_bin[ 25290 ], 28, 0 );
    const_str_digest_1bcbfd703e41ba80195b5a84d610dbd4 = UNSTREAM_STRING( &constant_bin[ 25318 ], 20, 0 );
    const_str_digest_dc2a0cea0cc8765646e6551215b10eac = UNSTREAM_STRING( &constant_bin[ 25338 ], 20, 0 );
    ...
    const_str_plain_MAX_NODE_LIMIT = UNSTREAM_STRING( &constant_bin[ 25358 ], 14, 1 );
    ...
    const_str_plain___all__ = UNSTREAM_STRING( &constant_bin[ 25372 ], 7, 1 );
    const_str_plain___builtins__ = UNSTREAM_STRING( &constant_bin[ 25379 ], 12, 1 );
    const_str_plain___class__ = UNSTREAM_STRING( &constant_bin[ 25391 ], 9, 1 );
    const_str_plain___cmp__ = UNSTREAM_STRING( &constant_bin[ 25400 ], 7, 1 );
    const_str_plain___delattr__ = UNSTREAM_STRING( &constant_bin[ 25407 ], 11, 1 );
    const_str_plain___dict__ = UNSTREAM_STRING( &constant_bin[ 25418 ], 8, 1 );
    const_str_plain___doc__ = UNSTREAM_STRING( &constant_bin[ 25426 ], 7, 1 );
    const_str_plain___enter__ = UNSTREAM_STRING( &constant_bin[ 25433 ], 9, 1 );
    const_str_plain___exit__ = UNSTREAM_STRING( &constant_bin[ 25442 ], 8, 1 );
    const_str_plain___file__ = UNSTREAM_STRING( &constant_bin[ 25450 ], 8, 1 );
    const_str_plain___getattr__ = UNSTREAM_STRING( &constant_bin[ 25458 ], 11, 1 );
    const_str_plain___import__ = UNSTREAM_STRING( &constant_bin[ 25469 ], 10, 1 );
    const_str_plain___init__ = UNSTREAM_STRING( &constant_bin[ 5293 ], 8, 1 );
    const_str_plain___main__ = UNSTREAM_STRING( &constant_bin[ 25479 ], 8, 1 );
    const_str_plain___metaclass__ = UNSTREAM_STRING( &constant_bin[ 25487 ], 13, 1 );
    const_str_plain___module__ = UNSTREAM_STRING( &constant_bin[ 25500 ], 10, 1 );
    const_str_plain___name__ = UNSTREAM_STRING( &constant_bin[ 25510 ], 8, 1 );
    const_str_plain___setattr__ = UNSTREAM_STRING( &constant_bin[ 25518 ], 11, 1 );
    const_str_plain_add = UNSTREAM_STRING( &constant_bin[ 7829 ], 3, 1 );
    const_str_plain_append = UNSTREAM_STRING( &constant_bin[ 25529 ], 6, 1 );
    ...
    const_str_plain_compile = UNSTREAM_STRING( &constant_bin[ 25535 ], 7, 1 );
    const_str_plain_contains_node = UNSTREAM_STRING( &constant_bin[ 25542 ], 13, 1 );
    const_str_plain_contains_span = UNSTREAM_STRING( &constant_bin[ 25555 ], 13, 1 );
    ...
    const_str_plain_diagram_to_key = UNSTREAM_STRING( &constant_bin[ 5201 ], 14, 1 );
    const_str_plain_exc_traceback = UNSTREAM_STRING( &constant_bin[ 25568 ], 13, 1 );
    const_str_plain_exc_type = UNSTREAM_STRING( &constant_bin[ 25581 ], 8, 1 );
    const_str_plain_exc_value = UNSTREAM_STRING( &constant_bin[ 25589 ], 9, 1 );
    const_str_plain_exit = UNSTREAM_STRING( &constant_bin[ 25444 ], 4, 1 );
    const_str_plain_format = UNSTREAM_STRING( &constant_bin[ 12410 ], 6, 1 );
    const_str_plain_gen_region_bounds = UNSTREAM_STRING( &constant_bin[ 5749 ], 17, 1 );
    const_str_plain_get = UNSTREAM_STRING( &constant_bin[ 3316 ], 3, 1 );
    const_str_plain_get_base_region = UNSTREAM_STRING( &constant_bin[ 25598 ], 15, 1 );
    const_str_plain_get_chord_by_node = UNSTREAM_STRING( &constant_bin[ 25613 ], 17, 1 );
    const_str_plain_get_first_region_id = UNSTREAM_STRING( &constant_bin[ 25630 ], 19, 1 );
    const_str_plain_get_lower_node = UNSTREAM_STRING( &constant_bin[ 25649 ], 14, 1 );
    const_str_plain_get_next_region_id = UNSTREAM_STRING( &constant_bin[ 25663 ], 18, 1 );
    const_str_plain_get_node_complement = UNSTREAM_STRING( &constant_bin[ 25681 ], 19, 1 );
    const_str_plain_get_other_node = UNSTREAM_STRING( &constant_bin[ 25700 ], 14, 1 );
    const_str_plain_get_regions_for_node = UNSTREAM_STRING( &constant_bin[ 5882 ], 20, 1 );
    const_str_plain_get_upper_node = UNSTREAM_STRING( &constant_bin[ 25714 ], 14, 1 );
    ...
    const_str_plain_inspect = UNSTREAM_STRING( &constant_bin[ 25728 ], 7, 1 );
    const_str_plain_int = UNSTREAM_STRING( &constant_bin[ 5162 ], 3, 1 );
    const_str_plain_is_node_on_region = UNSTREAM_STRING( &constant_bin[ 25735 ], 17, 1 );
    const_str_plain_is_planarable = UNSTREAM_STRING( &constant_bin[ 18341 ], 13, 1 );
    const_str_plain_iter = UNSTREAM_STRING( &constant_bin[ 5340 ], 4, 1 );
    const_str_plain_key = UNSTREAM_STRING( &constant_bin[ 3212 ], 3, 1 );
    const_str_plain_last = UNSTREAM_STRING( &constant_bin[ 646 ], 4, 1 );
    const_str_plain_len = UNSTREAM_STRING( &constant_bin[ 6559 ], 3, 1 );
    const_str_plain_length = UNSTREAM_STRING( &constant_bin[ 6559 ], 6, 1 );
    const_str_plain_list = UNSTREAM_STRING( &constant_bin[ 7388 ], 4, 1 );
    ...
    const_str_plain_long = UNSTREAM_STRING( &constant_bin[ 6504 ], 4, 1 );
    const_str_plain_low = UNSTREAM_STRING( &constant_bin[ 5821 ], 3, 1 );
    const_str_plain_math = UNSTREAM_STRING( &constant_bin[ 25752 ], 4, 1 );
    const_str_plain_max_node_closed = UNSTREAM_STRING( &constant_bin[ 25756 ], 15, 1 );
    const_str_plain_minus = UNSTREAM_STRING( &constant_bin[ 22133 ], 5, 1 );
    ...
    const_str_plain_object = UNSTREAM_STRING( &constant_bin[ 9098 ], 6, 1 );
    const_str_plain_open = UNSTREAM_STRING( &constant_bin[ 25771 ], 4, 1 );
    const_str_plain_opt = UNSTREAM_STRING( &constant_bin[ 4738 ], 3, 1 );
    const_str_plain_other_node = UNSTREAM_STRING( &constant_bin[ 25704 ], 10, 1 );
    const_str_plain_print_header = UNSTREAM_STRING( &constant_bin[ 5160 ], 12, 1 );
    const_str_plain_range = UNSTREAM_STRING( &constant_bin[ 7034 ], 5, 1 );
    const_str_plain_region = UNSTREAM_STRING( &constant_bin[ 174 ], 6, 1 );
    const_str_plain_region_factory = UNSTREAM_STRING( &constant_bin[ 25775 ], 14, 1 );
    ...
    const_str_plain_repr = UNSTREAM_STRING( &constant_bin[ 6668 ], 4, 1 );
    const_str_plain_result = UNSTREAM_STRING( &constant_bin[ 1117 ], 6, 1 );
    const_str_plain_reverse = UNSTREAM_STRING( &constant_bin[ 25789 ], 7, 1 );
    const_str_plain_self = UNSTREAM_STRING( &constant_bin[ 563 ], 4, 1 );
    const_str_plain_site = UNSTREAM_STRING( &constant_bin[ 5557 ], 4, 1 );
    const_str_plain_size = UNSTREAM_STRING( &constant_bin[ 4330 ], 4, 1 );
    const_str_plain_sorted = UNSTREAM_STRING( &constant_bin[ 5517 ], 6, 1 );
    const_str_plain_span = UNSTREAM_STRING( &constant_bin[ 280 ], 4, 1 );
    const_str_plain_split = UNSTREAM_STRING( &constant_bin[ 25796 ], 5, 1 );
    const_str_plain_staticmethod = UNSTREAM_STRING( &constant_bin[ 25801 ], 12, 1 );
    const_str_plain_stderr = UNSTREAM_STRING( &constant_bin[ 24905 ], 6, 1 );
    const_str_plain_strftime = UNSTREAM_STRING( &constant_bin[ 25813 ], 8, 1 );
    ...
    const_str_plain_type = UNSTREAM_STRING( &constant_bin[ 25585 ], 4, 1 );
    const_str_plain_update_dangling_spans = UNSTREAM_STRING( &constant_bin[ 25821 ], 21, 1 );
    const_str_plain_xrange = UNSTREAM_STRING( &constant_bin[ 25842 ], 6, 1 );
