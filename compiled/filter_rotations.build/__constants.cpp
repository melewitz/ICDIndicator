...
static void __initConstants( void )
{
    ...
    const_str_digest_03937373fabec6b1a26cee54a73d4917 = UNSTREAM_STRING( &constant_bin[ 32289 ], 28, 0 );
    const_str_digest_1bcbfd703e41ba80195b5a84d610dbd4 = UNSTREAM_STRING( &constant_bin[ 32317 ], 20, 0 );
    const_str_digest_dc2a0cea0cc8765646e6551215b10eac = UNSTREAM_STRING( &constant_bin[ 32337 ], 20, 0 );
    ...
    const_str_plain_ICDIndicator = UNSTREAM_STRING( &constant_bin[ 9085 ], 12, 1 );
    const_str_plain_MAX_NODE_LIMIT = UNSTREAM_STRING( &constant_bin[ 32357 ], 14, 1 );
    ...
    const_str_plain___all__ = UNSTREAM_STRING( &constant_bin[ 32371 ], 7, 1 );
    const_str_plain___builtins__ = UNSTREAM_STRING( &constant_bin[ 32378 ], 12, 1 );
    const_str_plain___class__ = UNSTREAM_STRING( &constant_bin[ 32390 ], 9, 1 );
    const_str_plain___cmp__ = UNSTREAM_STRING( &constant_bin[ 32399 ], 7, 1 );
    const_str_plain___delattr__ = UNSTREAM_STRING( &constant_bin[ 32406 ], 11, 1 );
    const_str_plain___dict__ = UNSTREAM_STRING( &constant_bin[ 32417 ], 8, 1 );
    const_str_plain___doc__ = UNSTREAM_STRING( &constant_bin[ 32425 ], 7, 1 );
    const_str_plain___enter__ = UNSTREAM_STRING( &constant_bin[ 32432 ], 9, 1 );
    const_str_plain___exit__ = UNSTREAM_STRING( &constant_bin[ 32441 ], 8, 1 );
    const_str_plain___file__ = UNSTREAM_STRING( &constant_bin[ 32449 ], 8, 1 );
    const_str_plain___getattr__ = UNSTREAM_STRING( &constant_bin[ 32457 ], 11, 1 );
    const_str_plain___import__ = UNSTREAM_STRING( &constant_bin[ 32468 ], 10, 1 );
    const_str_plain___init__ = UNSTREAM_STRING( &constant_bin[ 9111 ], 8, 1 );
    const_str_plain___main__ = UNSTREAM_STRING( &constant_bin[ 32478 ], 8, 1 );
    const_str_plain___metaclass__ = UNSTREAM_STRING( &constant_bin[ 32486 ], 13, 1 );
    const_str_plain___module__ = UNSTREAM_STRING( &constant_bin[ 32499 ], 10, 1 );
    const_str_plain___name__ = UNSTREAM_STRING( &constant_bin[ 32509 ], 8, 1 );
    const_str_plain___setattr__ = UNSTREAM_STRING( &constant_bin[ 32517 ], 11, 1 );
    const_str_plain_add = UNSTREAM_STRING( &constant_bin[ 5945 ], 3, 1 );
    const_str_plain_adjacent = UNSTREAM_STRING( &constant_bin[ 4595 ], 8, 1 );
    const_str_plain_append = UNSTREAM_STRING( &constant_bin[ 32528 ], 6, 1 );
    ...
    const_str_plain_compile = UNSTREAM_STRING( &constant_bin[ 32534 ], 7, 1 );
    const_str_plain_contains_node = UNSTREAM_STRING( &constant_bin[ 32541 ], 13, 1 );
    const_str_plain_contains_one_move = UNSTREAM_STRING( &constant_bin[ 7402 ], 17, 1 );
    const_str_plain_contains_span = UNSTREAM_STRING( &constant_bin[ 32554 ], 13, 1 );
    ...
    const_str_plain_delta = UNSTREAM_STRING( &constant_bin[ 32567 ], 5, 1 );
    ...
    const_str_plain_exc_traceback = UNSTREAM_STRING( &constant_bin[ 32572 ], 13, 1 );
    const_str_plain_exc_type = UNSTREAM_STRING( &constant_bin[ 32585 ], 8, 1 );
    const_str_plain_exc_value = UNSTREAM_STRING( &constant_bin[ 32593 ], 9, 1 );
    const_str_plain_exit = UNSTREAM_STRING( &constant_bin[ 32443 ], 4, 1 );
    const_str_plain_factor = UNSTREAM_STRING( &constant_bin[ 2741 ], 6, 1 );
    const_str_plain_format = UNSTREAM_STRING( &constant_bin[ 16225 ], 6, 1 );
    const_str_plain_gen_region_bounds = UNSTREAM_STRING( &constant_bin[ 9564 ], 17, 1 );
    const_str_plain_get = UNSTREAM_STRING( &constant_bin[ 3316 ], 3, 1 );
    const_str_plain_get_base_region = UNSTREAM_STRING( &constant_bin[ 32602 ], 15, 1 );
    const_str_plain_get_chord_by_node = UNSTREAM_STRING( &constant_bin[ 32617 ], 17, 1 );
    const_str_plain_get_compressed_diagram = UNSTREAM_STRING( &constant_bin[ 6215 ], 22, 1 );
    const_str_plain_get_first_region_id = UNSTREAM_STRING( &constant_bin[ 32634 ], 19, 1 );
    const_str_plain_get_lower_node = UNSTREAM_STRING( &constant_bin[ 32653 ], 14, 1 );
    const_str_plain_get_next_region_id = UNSTREAM_STRING( &constant_bin[ 32667 ], 18, 1 );
    const_str_plain_get_node_complement = UNSTREAM_STRING( &constant_bin[ 32685 ], 19, 1 );
    const_str_plain_get_other_node = UNSTREAM_STRING( &constant_bin[ 4965 ], 14, 1 );
    const_str_plain_get_regions_for_node = UNSTREAM_STRING( &constant_bin[ 9697 ], 20, 1 );
    const_str_plain_get_rotated_diagram = UNSTREAM_STRING( &constant_bin[ 6429 ], 19, 1 );
    const_str_plain_get_upper_node = UNSTREAM_STRING( &constant_bin[ 32704 ], 14, 1 );
    ...
    const_str_plain_inspect = UNSTREAM_STRING( &constant_bin[ 32718 ], 7, 1 );
    const_str_plain_int = UNSTREAM_STRING( &constant_bin[ 4640 ], 3, 1 );
    const_str_plain_is_node_on_region = UNSTREAM_STRING( &constant_bin[ 32725 ], 17, 1 );
    ...
    const_str_plain_len = UNSTREAM_STRING( &constant_bin[ 10374 ], 3, 1 );
    const_str_plain_length = UNSTREAM_STRING( &constant_bin[ 10374 ], 6, 1 );
    const_str_plain_list = UNSTREAM_STRING( &constant_bin[ 5401 ], 4, 1 );
    const_str_plain_load_diagrams_from_files = UNSTREAM_STRING( &constant_bin[ 8862 ], 24, 1 );
    const_str_plain_locator = UNSTREAM_STRING( &constant_bin[ 2054 ], 7, 1 );
    const_str_plain_log = UNSTREAM_STRING( &constant_bin[ 3550 ], 3, 1 );
    const_str_plain_long = UNSTREAM_STRING( &constant_bin[ 10319 ], 4, 1 );
    const_str_plain_low = UNSTREAM_STRING( &constant_bin[ 9636 ], 3, 1 );
    const_str_plain_main = UNSTREAM_STRING( &constant_bin[ 8557 ], 4, 1 );
    const_str_plain_math = UNSTREAM_STRING( &constant_bin[ 32742 ], 4, 1 );
    const_str_plain_max_node_closed = UNSTREAM_STRING( &constant_bin[ 32746 ], 15, 1 );
    const_str_plain_minus = UNSTREAM_STRING( &constant_bin[ 25948 ], 5, 1 );
    const_str_plain_msg = UNSTREAM_STRING( &constant_bin[ 31609 ], 3, 1 );
    ...
    const_str_plain_object = UNSTREAM_STRING( &constant_bin[ 12913 ], 6, 1 );
    const_str_plain_open = UNSTREAM_STRING( &constant_bin[ 32761 ], 4, 1 );
    ...
    const_str_plain_pop = UNSTREAM_STRING( &constant_bin[ 32765 ], 3, 1 );
    const_str_plain_print_header = UNSTREAM_STRING( &constant_bin[ 8915 ], 12, 1 );
    const_str_plain_range = UNSTREAM_STRING( &constant_bin[ 10849 ], 5, 1 );
    const_str_plain_region = UNSTREAM_STRING( &constant_bin[ 174 ], 6, 1 );
    const_str_plain_region_factory = UNSTREAM_STRING( &constant_bin[ 32768 ], 14, 1 );
    ...
    const_str_plain_repr = UNSTREAM_STRING( &constant_bin[ 10483 ], 4, 1 );
    const_str_plain_result = UNSTREAM_STRING( &constant_bin[ 1117 ], 6, 1 );
    const_str_plain_reverse = UNSTREAM_STRING( &constant_bin[ 32782 ], 7, 1 );
    const_str_plain_rots = UNSTREAM_STRING( &constant_bin[ 7005 ], 4, 1 );
    const_str_plain_scale = UNSTREAM_STRING( &constant_bin[ 7359 ], 5, 1 );
    const_str_plain_self = UNSTREAM_STRING( &constant_bin[ 563 ], 4, 1 );
    const_str_plain_site = UNSTREAM_STRING( &constant_bin[ 9372 ], 4, 1 );
    ...
    const_str_plain_split = UNSTREAM_STRING( &constant_bin[ 32789 ], 5, 1 );
    const_str_plain_staticmethod = UNSTREAM_STRING( &constant_bin[ 32794 ], 12, 1 );
    const_str_plain_stderr = UNSTREAM_STRING( &constant_bin[ 31726 ], 6, 1 );
    ...
    const_str_plain_type = UNSTREAM_STRING( &constant_bin[ 31125 ], 4, 1 );
    const_str_plain_update_dangling_spans = UNSTREAM_STRING( &constant_bin[ 32806 ], 21, 1 );
    const_str_plain_xrange = UNSTREAM_STRING( &constant_bin[ 32827 ], 6, 1 );
